...
function loadscroll() {
	if (state == false) {
		let elload = $("#Blog1_pagination-old");
		let link = elload.attr("href");
		$(".loader-table").html("<img alt='Loading' src='data:image/gif;base64,' style='width:auto;margin:auto' title='Loading'/><br/>Tunggu Sebentar Sedang Memuat URL : <br/>" + link).show();
		$("#datatablex").hide();
		state = true;
		if (link !== undefined) {
			$.ajax({
				...
				success: function(data) {
					let source = $(data).find(".blog-posts").length ? $(data) : $("<div/>");
